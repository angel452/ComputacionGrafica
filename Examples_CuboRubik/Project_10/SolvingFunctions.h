...
std::string* ReadAlgsFromFile(int a, int len)
{
	...
	{
	case 1:
		path = "E:/LabCompiler/glfw-master/OwnProjects/Project_10/Algorithms/F2L.txt";
		size = 103;
		break;
	case 2:
		path = "E:/LabCompiler/glfw-master/OwnProjects/Project_10/Algorithms/OLL.txt";
		size = 57;
		break;
	case 3:
		path = "E:/LabCompiler/glfw-master/OwnProjects/Project_10/Algorithms/PLL.txt";
		size = 21;
		break;
	case 4:
		path = "Algorithms/Scrambles.txt";
